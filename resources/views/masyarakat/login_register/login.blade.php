            ...
            <div style="box-shadow: 0 1px 1px rgba(0,0,0,0,0.4);" class="col-xs-8">
                <div class="row">
                    <div class="col-xs-6 p-0 hidden-android from-login">
                        <img height="389px;" width="500px;" src="{{ url('tema_utama/theme/image/service.jpg') }}" alt="img-fluid">
                    </div>
                    <div class="col-xs-6">
                        <div class="card" style="height:402px;">
                            <div class="card-header">
                                <h4> <span class="fa fa-fw fa-user"></span> Login User</h4>
                            </div>
                            ...
                            <div class="card-body" style="margin-top: -19px;">
                                ...
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input name="username" type="text" class="form-control @error('username') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value="{{ old('username') }}">
                                        @error('username')
